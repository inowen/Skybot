...
/**
 * Since org.lwjgl.input.Keyboard doesn't exist in Forge for some reason,
 * I copied its static fields for the keycodes here to use them.
 */
public class LwjglKeyboard {
    // Compiled from Keyboard.java (version 1.5 : 49.0, super bit)
